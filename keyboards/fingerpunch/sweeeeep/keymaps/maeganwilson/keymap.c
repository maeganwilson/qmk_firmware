...
[_DVORAK] = LAYOUT_sweeeeep_base(
  KC_SCLN,    KC_COMM,    KC_DOT,    KC_P,    KC_Y,         KC_F,    KC_G,    KC_C,    KC_R,    KC_L,
  KC_A,       KC_O,       KC_E,      KC_U,    KC_I,         KC_D,    KC_H,    KC_T,    KC_N,    KC_S,
  KC_QUOT,    KC_Q,       KC_J,      KC_K,    KC_X,         KC_B,    KC_M,    KC_W,    KC_V,    KC_C,
...
[_ADJUST] =  LAYOUT_sweeeeep(
  RGB_TOG, RGB_RMOD, RGB_MOD, _______, TO(_DVORAK),       KC_F1,   KC_F2,   KC_F3,   KC_F4,    KC_F5,
